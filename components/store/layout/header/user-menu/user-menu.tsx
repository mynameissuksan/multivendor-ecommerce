...
import { MessageIcon, OrderIcon } from "@/components/store/icons";
    ...
    <div className="relative group">
      ...
      <div className="">
        {user ? (
          ...
          <div className="flex w-50 h-11 items-center py-0 mx-2 cursor-pointer">
      ...
      <div
        className={cn(
          ...
          {
            "-left-50 lg:-left-32.5": user,
          }
        )}
      >
        <div className="relative left-2 mt-10 right-auto bottom-auto pt-2.5 text-[#222] p-0 text-sm z-40">
          {/* Triangle */}
          <div className="w-0 h-0 absolute left-35 top-1 right-24 border-l-10! border-l-transparent! border-r-10! border-r-transparent! border-b-10! border-b-white"></div>
          {/* Menu */}
          <div className="rounded-3xl bg-white text-sm text-[#222] shadow-lg">
            <div className="w-76.25">
              <div className="pt-5 px-6 pb-0">
                ...
                {/* <span className="block h-px w-full bg-[#ebebeb]"></span> */}
                <Separator />
              </div>
              {/* Links */}
              <div className="max-w-[calc(100vh-180px)] text-main-secondary overflow-auto overflow-x-hidden pt-0 px-2 pb-4">
