...
const SidebarNavSeller = ({
  ...
  const activeStore = pathname.split("/stores/")[1]?.split("/")[0] ?? "";
    ...
    <nav className="relative grow">
      <Command className="rounded-lg overflow-visible bg-transparent">
        ...
        <CommandList className="py-2 overflow-visible">
          ...
          <CommandGroup className="overflow-visible p-0 relative">
              ...
              return (
                ...
                >
                  <Link
                    ...
                    className="flex items-center gap-2 hover:bg-transparent rounded-md transition-all w-full text-lg"
                  >
